...
namespace SimpleSocialNetwork.DAL.Migrations
{
    ...
    [Migration("20231014092558_add_Message")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleSocialNetwork.DAL.Entity.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SimpleSocialNetwork.DAL.Entity.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SimpleSocialNetwork.DAL.Entity.Message", b =>
                {
                    b.HasOne("SimpleSocialNetwork.DAL.Entity.User", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId");

                    b.HasOne("SimpleSocialNetwork.DAL.Entity.User", "Sender")
                        .WithMany()
